...
CAMPO text_style.layout — distribución espacial del texto dentro de la zona:
  ...
  Distribución sugerida: P1=stacked, P2=spread, P3=staggered, P4=stacked, P5=spread, P6=staggered
  (o variación similar — lo importante es que aparezcan los 3 tipos al menos una vez)
...
[
  {
    ...
    "text_style": { "text_anchor": "top|center|bottom", "layout": "stacked|spread|staggered" },
...
def _validar_concepto(c: dict, idx: int) -> dict:
    ...
    defaults = {
        ...
        "text_style":       {
            ...
            "layout":          ["stacked", "spread", "staggered", "stacked", "spread", "staggered"][idx % 6],
            "margin_h":        0.07,
